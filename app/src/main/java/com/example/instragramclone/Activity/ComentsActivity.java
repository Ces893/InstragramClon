...
import com.example.instragramclone.Adapter.CommentsAdapter;
...
public class ComentsActivity extends AppCompatActivity {
    ...
    CommentsAdapter commentsAdapter;  // Declarar la instancia del adaptador aquí
    ...
    private void addComent() {
        ...
        addcoment.setText("");
        commentsAdapter.notifyDataSetChanged();  // Llama a notifyDataSetChanged() en la instancia del adaptador
    }
}
